...
{
    public partial class FrmBosKare : Form
    {
        public FrmBosKare()
        {
            InitializeComponent();
        ...
        private void BtnKareHesapla_Click(object sender, EventArgs e)
        {
            ...
            bilgi = karehesapla.bosKare();
            textEdit5.Text = Convert.ToString(karehesapla.bosKare());
        }

        private void FrmBosKare_Load(object sender, EventArgs e)
        {
